...
TEST(regression, main_test_1)
{
    ...
    for (int it_302_0 = 0; it_302_0 < 2; it_302_0 ++) {
        for (int it_302_1 = 0; it_302_1 < 2; it_302_1 ++) {
            EXPECT_EQ(expected_argv[it_302_0][it_302_1], _argv[it_302_0][it_302_1]);
        }
    }
}
...
{
    char _argv[2][2] = {{'c', 'c'}, {'5', ':'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_303_0 = 0; it_303_0 < 2; it_303_0 ++) {
        argv[it_303_0] = _argv[it_303_0];
    }
    argv[2] = NULL;
    int actual = main(2, argv);
    EXPECT_EQ(5, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'5', ':'}};
    for (int it_304_0 = 0; it_304_0 < 2; it_304_0 ++) {
        for (int it_304_1 = 0; it_304_1 < 2; it_304_1 ++) {
            EXPECT_EQ(expected_argv[it_304_0][it_304_1], _argv[it_304_0][it_304_1]);
        }
    }
}
...
TEST(regression, main_test_3)
{
    ...
    for (int it_306_0 = 0; it_306_0 < 2; it_306_0 ++) {
        for (int it_306_1 = 0; it_306_1 < 2; it_306_1 ++) {
            EXPECT_EQ(expected_argv[it_306_0][it_306_1], _argv[it_306_0][it_306_1]);
        }
    }
}
...
TEST(regression, main_test_4)
{
    ...
    for (int it_308_0 = 0; it_308_0 < 2; it_308_0 ++) {
        for (int it_308_1 = 0; it_308_1 < 2; it_308_1 ++) {
            EXPECT_EQ(expected_argv[it_308_0][it_308_1], _argv[it_308_0][it_308_1]);
        }
    }
}
...
TEST(regression, main_test_5)
{
    ...
    for (int it_310_0 = 0; it_310_0 < 2; it_310_0 ++) {
        for (int it_310_1 = 0; it_310_1 < 2; it_310_1 ++) {
            EXPECT_EQ(expected_argv[it_310_0][it_310_1], _argv[it_310_0][it_310_1]);
        }
    }
}
...
{
    char _argv[2][2] = {{'c', 'c'}, {'5', 'B'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_311_0 = 0; it_311_0 < 2; it_311_0 ++) {
        argv[it_311_0] = _argv[it_311_0];
    }
    argv[2] = NULL;
    int actual = main(2, argv);
    EXPECT_EQ(5, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'5', 'B'}};
    for (int it_312_0 = 0; it_312_0 < 2; it_312_0 ++) {
        for (int it_312_1 = 0; it_312_1 < 2; it_312_1 ++) {
            EXPECT_EQ(expected_argv[it_312_0][it_312_1], _argv[it_312_0][it_312_1]);
        }
    }
}
...
TEST(regression, main_test_7)
{
    ...
    for (int it_314_0 = 0; it_314_0 < 2; it_314_0 ++) {
        for (int it_314_1 = 0; it_314_1 < 2; it_314_1 ++) {
            EXPECT_EQ(expected_argv[it_314_0][it_314_1], _argv[it_314_0][it_314_1]);
        }
    }
}
...
TEST(regression, main_test_8)
{
    ...
    for (int it_316_0 = 0; it_316_0 < 2; it_316_0 ++) {
        for (int it_316_1 = 0; it_316_1 < 2; it_316_1 ++) {
            EXPECT_EQ(expected_argv[it_316_0][it_316_1], _argv[it_316_0][it_316_1]);
        }
    }
}
...
{
    char _argv[2][2] = {{'c', 'c'}, {'\f', 'i'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_317_0 = 0; it_317_0 < 2; it_317_0 ++) {
        argv[it_317_0] = _argv[it_317_0];
    }
    argv[2] = NULL;
    int actual = main(2, argv);
    EXPECT_EQ(2, actual);
    char expected_argv[2][2] = {{'c', 'c'}, {'\f', 'i'}};
    for (int it_318_0 = 0; it_318_0 < 2; it_318_0 ++) {
        for (int it_318_1 = 0; it_318_1 < 2; it_318_1 ++) {
            EXPECT_EQ(expected_argv[it_318_0][it_318_1], _argv[it_318_0][it_318_1]);
        }
    }
}
...
TEST(regression, main_test_10)
{
    ...
    for (int it_320_0 = 0; it_320_0 < 2; it_320_0 ++) {
        for (int it_320_1 = 0; it_320_1 < 2; it_320_1 ++) {
            EXPECT_EQ(expected_argv[it_320_0][it_320_1], _argv[it_320_0][it_320_1]);
        }
    }
}
...
TEST(regression, main_test_11)
{
    ...
    for (int it_322_0 = 0; it_322_0 < 2; it_322_0 ++) {
        for (int it_322_1 = 0; it_322_1 < 2; it_322_1 ++) {
            EXPECT_EQ(expected_argv[it_322_0][it_322_1], _argv[it_322_0][it_322_1]);
        }
    }
}
...
TEST(regression, main_test_12)
{
    ...
    for (int it_324_0 = 0; it_324_0 < 2; it_324_0 ++) {
        for (int it_324_1 = 0; it_324_1 < 2; it_324_1 ++) {
            EXPECT_EQ(expected_argv[it_324_0][it_324_1], _argv[it_324_0][it_324_1]);
        }
    }
}
...
TEST(error, main_test_16)
{
    char _argv[2][2] = {{'c', 'c'}, {'\n', '\r'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_328_0 = 0; it_328_0 < 2; it_328_0 ++) {
        argv[it_328_0] = _argv[it_328_0];
    }
    argv[2] = NULL;
    main(2, argv);
}
