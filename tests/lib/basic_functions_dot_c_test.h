...
extern "C" int max__lib_basic_functions_c(int a, int b);
static int max_(int a, int b) {
return max__lib_basic_functions_c(a, b);
}
extern "C" int min_lib_basic_functions_c(int a, int b);
static int min(int a, int b) {
return min_lib_basic_functions_c(a, b);
}
extern "C" int sqr_positive_lib_basic_functions_c(int a);
static int sqr_positive(int a) {
return sqr_positive_lib_basic_functions_c(a);
}
extern "C" int simple_loop_lib_basic_functions_c(unsigned int n);
static int simple_loop(unsigned int n) {
return simple_loop_lib_basic_functions_c(n);
}
