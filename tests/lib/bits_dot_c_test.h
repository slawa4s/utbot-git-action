...
extern "C" unsigned int NSE_BITS_CLZ64_lib_bits_c(unsigned long long uiiData);
static unsigned int NSE_BITS_CLZ64(unsigned long long uiiData) {
return NSE_BITS_CLZ64_lib_bits_c(uiiData);
}
extern "C" unsigned int foo1_lib_bits_c(const FOO_ATTRIBUTE *attrib, unsigned int num, unsigned int id, unsigned int *offset, unsigned int *len);
static unsigned int foo1(const FOO_ATTRIBUTE *attrib, unsigned int num, unsigned int id, unsigned int *offset, unsigned int *len) {
return foo1_lib_bits_c(attrib, num, id, offset, len);
}
