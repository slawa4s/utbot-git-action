...
{
    __attribute__ ((aligned(1))) char _argv[2][2] = {{'b', 'c'}, {'-', 'B'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_4_0 = 0; it_4_0 < 2; it_4_0 ++) {
        argv[it_4_0] = _argv[it_4_0];
    }
...
{
    __attribute__ ((aligned(1))) char _argv[2][2] = {{'b', 'c'}, {'3', 'B'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_4_0 = 0; it_4_0 < 2; it_4_0 ++) {
        argv[it_4_0] = _argv[it_4_0];
    }
    ...
    int actual = main(2, argv);
    EXPECT_EQ(3, actual);
    char expected_argv[2][2] = {'b', 'c', '3', 'B'};
    for (int it_5_0 = 0; it_5_0 < 2; it_5_0 ++) {
        for (int it_5_1 = 0; it_5_1 < 2; it_5_1 ++) {
            EXPECT_EQ(expected_argv[it_5_0][it_5_1], _argv[it_5_0][it_5_1]);
        }
...
{
    __attribute__ ((aligned(1))) char _argv[2][2] = {{'b', 'c'}, {'3', ':'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_4_0 = 0; it_4_0 < 2; it_4_0 ++) {
        argv[it_4_0] = _argv[it_4_0];
    }
...
{
    __attribute__ ((aligned(1))) char _argv[2][2] = {{'b', 'c'}, {'\f', 'B'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_4_0 = 0; it_4_0 < 2; it_4_0 ++) {
        argv[it_4_0] = _argv[it_4_0];
    }
...
{
    __attribute__ ((aligned(1))) char _argv[2][2] = {{'b', 'c'}, {'\f', 'p'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_4_0 = 0; it_4_0 < 2; it_4_0 ++) {
        argv[it_4_0] = _argv[it_4_0];
    }
