...
extern "C" int sum_up_to_lib_inner_inner_basic_functions_c(unsigned int n);
static int sum_up_to(unsigned int n) {
return sum_up_to_lib_inner_inner_basic_functions_c(n);
}
extern "C" int median_lib_inner_inner_basic_functions_c(int a, int b, int c);
static int median(int a, int b, int c) {
return median_lib_inner_inner_basic_functions_c(a, b, c);
}
