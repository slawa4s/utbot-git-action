...
extern "C" int out_of_bound_access_to_heap_lib_memory_c(int num);
static int out_of_bound_access_to_heap(int num) {
return out_of_bound_access_to_heap_lib_memory_c(num);
}
extern "C" int out_of_bound_access_to_stack_lib_memory_c(int num);
static int out_of_bound_access_to_stack(int num) {
return out_of_bound_access_to_stack_lib_memory_c(num);
}
extern "C" int (*g_lib_memory_c)[5];
int (&g)[5] = (*g_lib_memory_c);
extern "C" int out_of_bound_access_to_globals_lib_memory_c(int i);
static int out_of_bound_access_to_globals(int i) {
return out_of_bound_access_to_globals_lib_memory_c(i);
}
extern "C" int use_after_free_lib_memory_c();
static int use_after_free() {
return use_after_free_lib_memory_c();
}
extern "C" char *passthrough_lib_memory_c(char *p);
static char *passthrough(char *p) {
return passthrough_lib_memory_c(p);
}
extern "C" char *leak_stack_lib_memory_c();
static char *leak_stack() {
return leak_stack_lib_memory_c();
}
extern "C" char use_after_return_lib_memory_c();
static char use_after_return() {
return use_after_return_lib_memory_c();
}
extern "C" int use_after_scope_lib_memory_c();
static int use_after_scope() {
return use_after_scope_lib_memory_c();
}
extern "C" void double_free_lib_memory_c();
static void double_free() {
return double_free_lib_memory_c();
}
extern "C" int invalid_free_lib_memory_c();
static int invalid_free() {
return invalid_free_lib_memory_c();
}
