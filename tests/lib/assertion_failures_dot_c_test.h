...
extern "C" int buggy_function1_lib_assertion_failures_c(int a, int b);
static int buggy_function1(int a, int b) {
return buggy_function1_lib_assertion_failures_c(a, b);
}
extern "C" int buggy_function2_lib_assertion_failures_c(int a);
static int buggy_function2(int a) {
return buggy_function2_lib_assertion_failures_c(a);
}
extern "C" int buggy_function3_lib_assertion_failures_c(int a, int b);
static int buggy_function3(int a, int b) {
return buggy_function3_lib_assertion_failures_c(a, b);
}
