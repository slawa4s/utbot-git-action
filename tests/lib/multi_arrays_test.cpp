...
{
    __attribute__ ((aligned(1))) int a[2][2] = {{0, -9}, {-8, 1}};
    int actual = sumSign(a);
    EXPECT_EQ(-1, actual);
    int expected_a[2][2] = {0, -9, -8, 1};
    for (int it_1_0 = 0; it_1_0 < 2; it_1_0 ++) {
        for (int it_1_1 = 0; it_1_1 < 2; it_1_1 ++) {
            EXPECT_EQ(expected_a[it_1_0][it_1_1], a[it_1_0][it_1_1]);
        }
...
{
    __attribute__ ((aligned(1))) int a[2][2] = {{0, 0}, {2, 1}};
    int actual = sumSign(a);
    EXPECT_EQ(1, actual);
    int expected_a[2][2] = {0, 0, 2, 1};
    for (int it_1_0 = 0; it_1_0 < 2; it_1_0 ++) {
        for (int it_1_1 = 0; it_1_1 < 2; it_1_1 ++) {
            EXPECT_EQ(expected_a[it_1_0][it_1_1], a[it_1_0][it_1_1]);
        }
...
{
    int actual = return_sign_sum({{{{-2, -3}, {7, 1}, {-10, 7}}, {{0, 7}, {-8, -9}, {-5, 9}}}});
    EXPECT_EQ(-1, actual);
}
...
TEST(regression, sum_matrix_test_1)
{
    ...
    int expected_matrix_a[3][2] = {9, 5, -4, 5, -1, -1};
    for (int it_8_0 = 0; it_8_0 < 3; it_8_0 ++) {
        for (int it_8_1 = 0; it_8_1 < 2; it_8_1 ++) {
            EXPECT_EQ(expected_matrix_a[it_8_0][it_8_1], matrix_a[it_8_0][it_8_1]);
        }
    }
    int expected_matrix_b[3][2] = {-2, -2, -1, -2, -2, 0};
    for (int it_8_0 = 0; it_8_0 < 3; it_8_0 ++) {
        for (int it_8_1 = 0; it_8_1 < 2; it_8_1 ++) {
