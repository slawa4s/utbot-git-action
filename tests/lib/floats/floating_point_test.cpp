...
{
    int actual = is_close(2.070328e+00, 0);
    EXPECT_EQ(0, actual);
}
...
{
    __attribute__ ((aligned(1))) float arr[10] = {2.000061e+00, 4.849059e-38, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    int actual = array_max(arr);
    EXPECT_EQ(1, actual);
    float expected_arr[10] = {2.000061e+00, 4.849059e-38, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
...
{
    __attribute__ ((aligned(1))) float arr[10] = {-6.151946e-05, -1.537986e-05, -1.907378e-06, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    int actual = array_max(arr);
    EXPECT_EQ(-1, actual);
    float expected_arr[10] = {-6.151946e-05, -1.537986e-05, -1.907378e-06, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_NEAR(expected_arr[it_3_0], arr[it_3_0], utbot_abs_error);
    }
}
...
{
    __attribute__ ((aligned(1))) float arr[10] = {-6.866641e-05, -1.373329e-04, -2.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    int actual = array_max(arr);
    EXPECT_EQ(-1, actual);
    float expected_arr[10] = {-6.866641e-05, -1.373329e-04, -2.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_NEAR(expected_arr[it_3_0], arr[it_3_0], utbot_abs_error);
    }
}
...
{
    __attribute__ ((aligned(1))) float arr[10] = {-6.151479e-05, -6.000123e+00, -1.907349e-06, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    int actual = array_max(arr);
    EXPECT_EQ(-1, actual);
    float expected_arr[10] = {-6.151479e-05, -6.000123e+00, -1.907349e-06, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_NEAR(expected_arr[it_3_0], arr[it_3_0], utbot_abs_error);
    }
}
