...
extern "C" int get_double_sign_lib_floats_floating_point_c(double x);
static int get_double_sign(double x) {
return get_double_sign_lib_floats_floating_point_c(x);
}
extern "C" int is_close_lib_floats_floating_point_c(float_t x, int y);
static int is_close(float_t x, int y) {
return is_close_lib_floats_floating_point_c(x, y);
}
extern "C" float long_double_arith_lib_floats_floating_point_c(long double x);
static float long_double_arith(long double x) {
return long_double_arith_lib_floats_floating_point_c(x);
}
extern "C" int array_max_lib_floats_floating_point_c(float arr[]);
static int array_max(float arr[]) {
return array_max_lib_floats_floating_point_c(arr);
}
extern "C" struct FParray fp_array_lib_floats_floating_point_c(int a);
static struct FParray fp_array(int a) {
return fp_array_lib_floats_floating_point_c(a);
}
