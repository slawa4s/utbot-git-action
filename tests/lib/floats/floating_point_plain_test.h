...
extern "C" int plain_isnan_lib_floats_floating_point_plain_c(float x);
static int plain_isnan(float x) {
return plain_isnan_lib_floats_floating_point_plain_c(x);
}
