...
TEST(regression, length_of_linked_list3_test_3)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {0, (struct Node *) 4278190080};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = length_of_linked_list3(&head);
    EXPECT_EQ(-1, actual);
...
TEST(regression, cycle_list3_test_6)
{
    ...
    struct Node utbotInnerVar2 = {1061109567, (struct Node *) 1360688725924};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = cycle_list3(&head);
    EXPECT_EQ(17, actual);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {808464432, NULL};
    struct Node utbotInnerVar2 = {640034342, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {67372036, NULL};
    struct Node utbotInnerVar2 = {-1734829928, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
TEST(regression, sort_list_test_5)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {-50529028, NULL};
...
TEST(regression, sort_list_with_comparator_test_2)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 1, 1, 2, -1, 2, 0, 2, 1, 0};
...
TEST(regression, sort_list_with_comparator_test_3)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 1, 1, 2, -1, 2, 1, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_5)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 1, 1, 2, -1, 2, 1, 2, 0, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(-1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_6)
{
    ...
    struct Node utbotInnerVar1 = {67372036, NULL};
    struct Node utbotInnerVar2 = {0, NULL};
    struct Node utbotInnerVar3 = {0, (struct Node *) 255};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
...
TEST(regression, sort_list_with_comparator_test_7)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {2, 1, 1, 2, -1, 2, 1, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
{
    char vowel_symbolic_buffer[] = {'g', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
...
{
    char vowel_symbolic_buffer[] = {'a', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'o', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'e', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'i', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'u', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'y', 'c', 'b', 'c', 'c', 'a', 'c', 'c', 'c', 'c'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('a', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {134744072, (struct Node *) 4294967304};
    head.next = &utbotInnerVar1;
    length_of_linked_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 8589934600};
    head.next = &utbotInnerVar1;
    sum_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 36028803528523784};
    head.next = &utbotInnerVar1;
    cycle_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 36028797018963976};
    head.next = &utbotInnerVar1;
    len_bound(&head, 8);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 17179869192};
    head.next = &utbotInnerVar1;
    sort_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
