...
TEST(regression, length_of_linked_list3_test_3)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {0, (struct Node *) 1095216660480};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = length_of_linked_list3(&head);
    EXPECT_EQ(-1, actual);
...
TEST(regression, middle_length2_test_3)
{
    ...
    struct Kuku utbotInnerVar1 = {{NULL, '\0'}, 0};
    head.in.next = &utbotInnerVar1;
    utbotInnerVar1.in.next = &utbotInnerVar1;
    int actual = middle_length2(&head);
    EXPECT_EQ(-1, actual);
    struct Kuku expected_head = {{(struct Kuku *) 7161677110969590627, 'c'}, 0};
    EXPECT_EQ(expected_head.in.letter, head.in.letter);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {117901063, NULL};
    struct Node utbotInnerVar2 = {0, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = cycle_list3(&head);
...
TEST(regression, cycle_list3_test_6)
{
    ...
    struct Node utbotInnerVar2 = {555819297, (struct Node *) 1732268608081498145};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = cycle_list3(&head);
    EXPECT_EQ(17, actual);
...
TEST(regression, cycle_list3_test_8)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {-1061109568, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {16843009, NULL};
    struct Node utbotInnerVar2 = {-2139062144, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {2147483646, NULL};
    struct Node utbotInnerVar2 = {2147483646, NULL};
    struct Node utbotInnerVar3 = {2146435070, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {2130706430, NULL};
    struct Node utbotInnerVar2 = {2130837502, NULL};
    struct Node utbotInnerVar3 = {2130706430, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int actual = sort_list(&head);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {33686018, NULL};
    struct Node utbotInnerVar2 = {-825307442, NULL};
...
TEST(regression, sort_list_with_comparator_test_2)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 0, 2, 1, -1, 2, 1, 2, 0, 0};
...
TEST(regression, sort_list_with_comparator_test_3)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 0, 2, 1, -1, 2, 0, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(-1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_5)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {2, 1, 2, 1, -1, 2, 1, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_6)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 1, 2, 1, -1, 2, 1, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_8)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 0, 2, 1, -1, 2, 1, 2, 1, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
{
    char vowel_symbolic_buffer[] = {'g', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(-1, actual);
}

TEST(regression, vowel_consonant_test_2)
{
    char vowel_symbolic_buffer[] = {'a', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'o', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'e', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'i', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'u', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'y', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('b', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {-2004318072, (struct Node *) 136};
    head.next = &utbotInnerVar1;
    length_of_linked_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
TEST(error, sum_list_test_3)
{
    ...
    struct Node utbotInnerVar2 = {0, (struct Node *) 127};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    sum_list(&head);
    struct Node expected_head = {0, NULL};
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {-2139062144, (struct Node *) 9223372036854775816};
    head.next = &utbotInnerVar1;
    sum_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 18014398509481992};
    head.next = &utbotInnerVar1;
    sign_sum(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Kuku head = {{(struct Kuku *) 255, 'a'}, 0};
    middle_length2(&head);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {16843009, (struct Node *) 264};
    head.next = &utbotInnerVar1;
    cycle_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {-1, (struct Node *) 18446181123756130303};
    head.next = &utbotInnerVar1;
    cycle_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {1616928864, (struct Node *) 16312037850335936520};
    head.next = &utbotInnerVar1;
    len_bound(&head, 8);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {202116108, NULL};
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {33686018, (struct Node *) 144115188075855880};
    head.next = &utbotInnerVar1;
    sort_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
