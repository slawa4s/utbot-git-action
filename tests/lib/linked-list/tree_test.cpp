...
TEST(regression, deep_test_2)
{
    ...
    struct Tree utbotInnerVar1 = {(struct Tree *) 144680345676153346, NULL};
...
{
    struct Tree root = {NULL, (struct Tree *) 9611398041860833288};
    struct Tree utbotInnerVar1 = {(struct Tree *) 9621242987464197509, (struct Tree *) 9611398041860833288};
    root.left = &utbotInnerVar1;
    deep(&root);
    struct Tree expected_root = {NULL, NULL};
}
