...
{
    struct Tree root = {NULL, NULL};
    struct Tree utbotInnerVar1 = {(struct Tree *) 4629771061636907072, NULL};
    struct Tree utbotInnerVar2 = {NULL, NULL};
    root.left = &utbotInnerVar1;
    root.right = &utbotInnerVar2;
    utbotInnerVar1.right = &utbotInnerVar2;
...
{
    struct Tree root = {NULL, (struct Tree *) 9216};
    struct Tree utbotInnerVar1 = {NULL, (struct Tree *) 9216};
    root.left = &utbotInnerVar1;
    deep(&root);
    struct Tree expected_root = {NULL, NULL};
}
...
{
    struct Tree root = {NULL, (struct Tree *) 254};
    struct Tree utbotInnerVar1 = {NULL, (struct Tree *) 254};
    root.left = &utbotInnerVar1;
    deep(&root);
    struct Tree expected_root = {NULL, NULL};
}
