...
TEST(regression, main_test_8)
{
    ...
    for (int it_356_0 = 0; it_356_0 < 2; it_356_0 ++) {
        for (int it_356_1 = 0; it_356_1 < 2; it_356_1 ++) {
            EXPECT_EQ(expected_argv[it_356_0][it_356_1], _argv[it_356_0][it_356_1]);
        }
    }
}
...
TEST(error, main_test_11)
{
    char _argv[2][2] = {{'c', 'b'}, {' ', '+'}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_359_0 = 0; it_359_0 < 2; it_359_0 ++) {
        argv[it_359_0] = _argv[it_359_0];
    }
    argv[2] = NULL;
    main(2, argv);
}
...
TEST(error, main_test_12)
{
    char _argv[2][2] = {{'c', 'b'}, {' ', ' '}};
    char ** argv = (char **) calloc(3, sizeof(char *));
    for (int it_360_0 = 0; it_360_0 < 2; it_360_0 ++) {
        argv[it_360_0] = _argv[it_360_0];
    }
    argv[2] = NULL;
    main(2, argv);
}
