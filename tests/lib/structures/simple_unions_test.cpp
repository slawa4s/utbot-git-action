...
{
    int actual = get_sign_union(from_bytes<IntBytesUnion>({112, 97, 97, -128}));
    EXPECT_EQ(-1, actual);
}
...
{
    int actual = extract_bit(from_bytes<ShortBytesUnion>({97, 99}));
    EXPECT_EQ(0, actual);
}
...
{
    __attribute__ ((aligned(1))) union IntBytesUnion u[10] = {from_bytes<IntBytesUnion>({97, 112, 97, 97}), from_bytes<IntBytesUnion>({98, 104, 97, 112}), from_bytes<IntBytesUnion>({98, 104, 98, 104}), from_bytes<IntBytesUnion>({112, 112, 97, 104}), from_bytes<IntBytesUnion>({104, 97, 97, 97}), from_bytes<IntBytesUnion>({97, 104, 112, 97}), from_bytes<IntBytesUnion>({104, 112, 112, 98}), from_bytes<IntBytesUnion>({112, 99, 98, 98}), from_bytes<IntBytesUnion>({104, 98, 98, 112}), from_bytes<IntBytesUnion>({97, 112, 97, 98})};
    int actual = sumOfUnionArray(u);
    EXPECT_EQ(65540861, actual);
    union IntBytesUnion expected_u[10] = {from_bytes<IntBytesUnion>({97, 112, 97, 97}), from_bytes<IntBytesUnion>({98, 104, 97, 112}), from_bytes<IntBytesUnion>({98, 104, 98, 104}), from_bytes<IntBytesUnion>({112, 112, 97, 104}), from_bytes<IntBytesUnion>({104, 97, 97, 97}), from_bytes<IntBytesUnion>({97, 104, 112, 97}), from_bytes<IntBytesUnion>({104, 112, 112, 98}), from_bytes<IntBytesUnion>({112, 99, 98, 98}), from_bytes<IntBytesUnion>({104, 98, 98, 112}), from_bytes<IntBytesUnion>({97, 112, 97, 98})};
