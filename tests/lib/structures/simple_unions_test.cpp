...
{
    __attribute__ ((aligned(1))) union IntBytesUnion u[10] = {from_bytes<IntBytesUnion>({98, 104, 97, 98}), from_bytes<IntBytesUnion>({97, 104, 112, 112}), from_bytes<IntBytesUnion>({104, 97, 98, 112}), from_bytes<IntBytesUnion>({104, 112, 104, 98}), from_bytes<IntBytesUnion>({104, 97, 97, 97}), from_bytes<IntBytesUnion>({98, 112, 104, 112}), from_bytes<IntBytesUnion>({97, 98, 98, 98}), from_bytes<IntBytesUnion>({97, 98, 98, 97}), from_bytes<IntBytesUnion>({104, 99, 112, 112}), from_bytes<IntBytesUnion>({98, 98, 104, 98})};
    int actual = sumOfUnionArray(u);
    EXPECT_EQ(117310459, actual);
    union IntBytesUnion expected_u[10] = {from_bytes<IntBytesUnion>({98, 104, 97, 98}), from_bytes<IntBytesUnion>({97, 104, 112, 112}), from_bytes<IntBytesUnion>({104, 97, 98, 112}), from_bytes<IntBytesUnion>({104, 112, 104, 98}), from_bytes<IntBytesUnion>({104, 97, 97, 97}), from_bytes<IntBytesUnion>({98, 112, 104, 112}), from_bytes<IntBytesUnion>({97, 98, 98, 98}), from_bytes<IntBytesUnion>({97, 98, 98, 97}), from_bytes<IntBytesUnion>({104, 99, 112, 112}), from_bytes<IntBytesUnion>({98, 98, 104, 98})};
