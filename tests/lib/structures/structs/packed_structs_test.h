...
extern "C" int get_sign_packedStruct1_lib_structures_structs_packed_structs_c(struct PackedStruct1 st);
static int get_sign_packedStruct1(struct PackedStruct1 st) {
return get_sign_packedStruct1_lib_structures_structs_packed_structs_c(st);
}
extern "C" char get_val_by_packedStruct2_lib_structures_structs_packed_structs_c(struct PackedStruct2 st);
static char get_val_by_packedStruct2(struct PackedStruct2 st) {
return get_val_by_packedStruct2_lib_structures_structs_packed_structs_c(st);
}
extern "C" short get_val_by_otherPackedStruct_lib_structures_structs_packed_structs_c(struct OtherPackedStruct st);
static short get_val_by_otherPackedStruct(struct OtherPackedStruct st) {
return get_val_by_otherPackedStruct_lib_structures_structs_packed_structs_c(st);
}
