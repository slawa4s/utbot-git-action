...
{
    char actual = get_symbol_by_struct({'b', 's', 97, 1});
    EXPECT_EQ('1', actual);
}
...
{
    char actual = get_symbol_by_struct({'b', 's', 117, 0});
    EXPECT_EQ('u', actual);
}
...
{
    char actual = get_symbol_by_struct({'b', 's', 97, 0});
    EXPECT_EQ('0', actual);
}
...
{
    signed char actual = operate_with_inner_structs({{'b', {1U, 0LL}, 0}, 0, 0LL});
    EXPECT_EQ('g', actual);
}
...
{
    signed char actual = operate_with_inner_structs({{'b', {0U, 0LL}, 0}, 5, 101LL});
    EXPECT_EQ('e', actual);
}

TEST(regression, operate_with_inner_structs_test_4)
{
    signed char actual = operate_with_inner_structs({{'b', {0U, 0LL}, 0}, 0, 0LL});
    EXPECT_EQ('e', actual);
}

TEST(regression, operate_with_inner_structs_test_5)
{
    signed char actual = operate_with_inner_structs({{'b', {0U, 0LL}, 0}, 5, 5LL});
    EXPECT_EQ('e', actual);
}

TEST(regression, operate_with_inner_structs_test_6)
{
    signed char actual = operate_with_inner_structs({{'b', {0U, 0LL}, 0}, 5, 0LL});
    EXPECT_EQ('e', actual);
}
...
{
    signed char actual = operate_with_inner_structs({{'b', {0U, 1LL}, 0}, 0, 0LL});
    EXPECT_EQ('o', actual);
}
...
{
    struct StructWithUnion actual = struct_with_union_as_return_type(7);
