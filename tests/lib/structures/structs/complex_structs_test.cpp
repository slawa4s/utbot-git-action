...
{
    int actual = struct_has_alphabet({0, {'A', 'B', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'a', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_2)
{
    int actual = struct_has_alphabet({2, {'c', 'b', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'a', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_3)
{
    int actual = struct_has_alphabet({0, {'A', 'c', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'a', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_4)
{
    int actual = struct_has_alphabet({0, {'c', 'b', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'a', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_5)
{
...
{
    char actual = arrays_in_inner_structs({{'c', 's'}, 2, {{0, 0, 0, 0, 0}}});
    EXPECT_EQ('1', actual);
}
