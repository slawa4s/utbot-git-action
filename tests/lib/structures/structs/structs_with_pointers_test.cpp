...
{
    long long actual = sum_of_all_fields_or_mult({1LL, 1, {8, NULL}}, -322);
...
{
    struct StructWithPointerInField actual = some_calc(10, -4);
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {NULL, -522133280};
    struct List utbotInnerVar2 = {(struct List *) 223, 0};
    head.next = &utbotInnerVar1;
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {(struct List *) 8388616, 0};
    head.next = &utbotInnerVar1;
    list_sum(&head);
    struct List expected_head = {NULL, 0};
    EXPECT_EQ(expected_head.val, head.val);
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {(struct List *) 8589934600, 0};
    head.next = &utbotInnerVar1;
    list_sum_sign(&head);
    struct List expected_head = {NULL, 0};
    EXPECT_EQ(expected_head.val, head.val);
