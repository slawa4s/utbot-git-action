...
extern "C" int struct_has_alphabet_lib_structures_structs_complex_structs_c(struct One st);
static int struct_has_alphabet(struct One st) {
return struct_has_alphabet_lib_structures_structs_complex_structs_c(st);
}
extern "C" char arrays_in_inner_structs_lib_structures_structs_complex_structs_c(struct Three st);
static char arrays_in_inner_structs(struct Three st) {
return arrays_in_inner_structs_lib_structures_structs_complex_structs_c(st);
}
extern "C" struct One alphabet_lib_structures_structs_complex_structs_c(int a);
static struct One alphabet(int a) {
return alphabet_lib_structures_structs_complex_structs_c(a);
}
