...
extern "C" int index_of_needed_struct_lib_structures_struct_arrays_c(struct CharAndInt *arr);
static int index_of_needed_struct(struct CharAndInt *arr) {
return index_of_needed_struct_lib_structures_struct_arrays_c(arr);
}
extern "C" int index_of_struct_with_equal_fields_lib_structures_struct_arrays_c(struct Trio arr[]);
static int index_of_struct_with_equal_fields(struct Trio arr[]) {
return index_of_struct_with_equal_fields_lib_structures_struct_arrays_c(arr);
}
