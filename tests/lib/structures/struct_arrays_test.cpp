...
{
    __attribute__ ((aligned(1))) struct CharAndInt arr[10] = {{'p', 0}, {'c', 0}, {'c', 128}, {'c', 0}, {'c', 0}, {'c', 0}, {'b', 0}, {'c', 0}, {'c', 0}, {'c', 0}};
    int actual = index_of_needed_struct(arr);
    EXPECT_EQ(2, actual);
    struct CharAndInt expected_arr[10] = {{'p', 0}, {'c', 0}, {'c', 128}, {'c', 0}, {'c', 0}, {'c', 0}, {'b', 0}, {'c', 0}, {'c', 0}, {'c', 0}};
...
{
    __attribute__ ((aligned(1))) struct CharAndInt arr[10] = {{'p', 0}, {'c', 128}, {'c', 0}, {'c', 0}, {'c', 0}, {'c', 0}, {'b', 0}, {'c', 0}, {'c', 0}, {'c', 0}};
    int actual = index_of_needed_struct(arr);
    EXPECT_EQ(1, actual);
    struct CharAndInt expected_arr[10] = {{'p', 0}, {'c', 128}, {'c', 0}, {'c', 0}, {'c', 0}, {'c', 0}, {'b', 0}, {'c', 0}, {'c', 0}, {'c', 0}};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_EQ(expected_arr[it_3_0].c, arr[it_3_0].c);
        EXPECT_EQ(expected_arr[it_3_0].x, arr[it_3_0].x);
    }
...
{
    __attribute__ ((aligned(1))) struct CharAndInt arr[10] = {{'p', 0}, {'c', 0}, {'p', 0}, {'s', 0}, {'a', 0}, {'b', 0}, {'h', 0}, {'h', 0}, {'s', 0}, {'b', 0}};
    int actual = index_of_needed_struct(arr);
    EXPECT_EQ(-1, actual);
    struct CharAndInt expected_arr[10] = {{'p', 0}, {'c', 0}, {'p', 0}, {'s', 0}, {'a', 0}, {'b', 0}, {'h', 0}, {'h', 0}, {'s', 0}, {'b', 0}};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_EQ(expected_arr[it_3_0].c, arr[it_3_0].c);
        EXPECT_EQ(expected_arr[it_3_0].x, arr[it_3_0].x);
    }
...
{
    __attribute__ ((aligned(1))) struct Trio arr[10] = {{0, 8LL, 0}, {8, 8LL, 0}, {0, 1LL, 0}, {0, 1LL, 0}, {0, 8LL, 0}, {0, 1LL, 0}, {0, 8LL, 0}, {0, 8LL, 0}, {0, 1LL, 0}, {0, 1LL, 0}};
    int actual = index_of_struct_with_equal_fields(arr);
    EXPECT_EQ(-1, actual);
    struct Trio expected_arr[10] = {{0, 8LL, 0}, {8, 8LL, 0}, {0, 1LL, 0}, {0, 1LL, 0}, {0, 8LL, 0}, {0, 1LL, 0}, {0, 8LL, 0}, {0, 8LL, 0}, {0, 1LL, 0}, {0, 1LL, 0}};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
