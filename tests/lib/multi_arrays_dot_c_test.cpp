...
TEST(regression, kek_test_1)
{
    ...
    for (int it_361_0 = 0; it_361_0 < 2; it_361_0 ++) {
        for (int it_361_1 = 0; it_361_1 < 2; it_361_1 ++) {
            EXPECT_EQ(expected_a[it_361_0][it_361_1], a[it_361_0][it_361_1]);
        }
    }
}
...
TEST(regression, sumSign_test_1)
{
    ...
    EXPECT_EQ(0, actual);
    int expected_a[2][2] = {{0, 0}, {0, 0}};
    for (int it_362_0 = 0; it_362_0 < 2; it_362_0 ++) {
        for (int it_362_1 = 0; it_362_1 < 2; it_362_1 ++) {
            EXPECT_EQ(expected_a[it_362_0][it_362_1], a[it_362_0][it_362_1]);
        }
    }
}
...
TEST(regression, value_test_1)
{
    ...
    for (int it_365_0 = 0; it_365_0 < 2; it_365_0 ++) {
        for (int it_365_1 = 0; it_365_1 < 3; it_365_1 ++) {
...
TEST(regression, value_test_2)
{
    ...
    for (int it_366_0 = 0; it_366_0 < 2; it_366_0 ++) {
        for (int it_366_1 = 0; it_366_1 < 3; it_366_1 ++) {
...
TEST(regression, some_method_test_1)
{
    ...
    for (int it_373_0 = 0; it_373_0 < 2; it_373_0 ++) {
        pointer2d[it_373_0] = _pointer2d[it_373_0];
    }
    pointer2d[2] = NULL;
    ...
    for (int it_374_0 = 0; it_374_0 < 2; it_374_0 ++) {
        for (int it_374_1 = 0; it_374_1 < 2; it_374_1 ++) {
            EXPECT_EQ(expected_pointer2d[it_374_0][it_374_1], _pointer2d[it_374_0][it_374_1]);
        }
    }
}
...
TEST(regression, return_sign_sum_of_struct_array_test_1)
{
    ...
    for (int it_383_0 = 0; it_383_0 < 2; it_383_0 ++) {
        for (int it_383_1 = 0; it_383_1 < 2; it_383_1 ++) {
            EXPECT_EQ(expected_arr[it_383_0][it_383_1].x, arr[it_383_0][it_383_1].x);
            EXPECT_EQ(expected_arr[it_383_0][it_383_1].y, arr[it_383_0][it_383_1].y);
        }
    }
}
...
TEST(regression, return_sign_sum_of_struct_array_test_2)
{
    ...
    for (int it_384_0 = 0; it_384_0 < 2; it_384_0 ++) {
        for (int it_384_1 = 0; it_384_1 < 2; it_384_1 ++) {
            EXPECT_EQ(expected_arr[it_384_0][it_384_1].x, arr[it_384_0][it_384_1].x);
            EXPECT_EQ(expected_arr[it_384_0][it_384_1].y, arr[it_384_0][it_384_1].y);
        }
    }
}
...
TEST(regression, point_quart_test_1)
{
    ...
    for (int it_385_0 = 0; it_385_0 < 2; it_385_0 ++) {
        point[it_385_0] = _point[it_385_0];
    }
    point[2] = NULL;
    ...
    for (int it_386_0 = 0; it_386_0 < 2; it_386_0 ++) {
        for (int it_386_1 = 0; it_386_1 < 2; it_386_1 ++) {
            EXPECT_EQ(expected_point[it_386_0][it_386_1].x, _point[it_386_0][it_386_1].x);
            EXPECT_EQ(expected_point[it_386_0][it_386_1].y, _point[it_386_0][it_386_1].y);
        }
    }
}
...
TEST(regression, sum_matrix_test_1)
{
    ...
    for (int it_393_0 = 0; it_393_0 < 3; it_393_0 ++) {
        for (int it_393_1 = 0; it_393_1 < 2; it_393_1 ++) {
            EXPECT_EQ(expected_matrix_c[it_393_0][it_393_1], matrix_c[it_393_0][it_393_1]);
        }
    }
    int expected_matrix_a[3][2] = {{-1, 0}, {0, 0}, {0, 0}};
    for (int it_394_0 = 0; it_394_0 < 3; it_394_0 ++) {
        for (int it_394_1 = 0; it_394_1 < 2; it_394_1 ++) {
            EXPECT_EQ(expected_matrix_a[it_394_0][it_394_1], matrix_a[it_394_0][it_394_1]);
        }
    }
    int expected_matrix_b[3][2] = {{0, 0}, {0, 0}, {0, 0}};
    for (int it_395_0 = 0; it_395_0 < 3; it_395_0 ++) {
        for (int it_395_1 = 0; it_395_1 < 2; it_395_1 ++) {
            EXPECT_EQ(expected_matrix_b[it_395_0][it_395_1], matrix_b[it_395_0][it_395_1]);
        }
    }
}
...
TEST(regression, sum_matrix_test_2)
{
    ...
    for (int it_396_0 = 0; it_396_0 < 3; it_396_0 ++) {
        for (int it_396_1 = 0; it_396_1 < 2; it_396_1 ++) {
            EXPECT_EQ(expected_matrix_c[it_396_0][it_396_1], matrix_c[it_396_0][it_396_1]);
        }
    }
    int expected_matrix_a[3][2] = {{0, 0}, {0, 0}, {0, 0}};
    for (int it_397_0 = 0; it_397_0 < 3; it_397_0 ++) {
        for (int it_397_1 = 0; it_397_1 < 2; it_397_1 ++) {
            EXPECT_EQ(expected_matrix_a[it_397_0][it_397_1], matrix_a[it_397_0][it_397_1]);
        }
    }
    int expected_matrix_b[3][2] = {{0, 0}, {0, 0}, {0, 0}};
    for (int it_398_0 = 0; it_398_0 < 3; it_398_0 ++) {
        for (int it_398_1 = 0; it_398_1 < 2; it_398_1 ++) {
            EXPECT_EQ(expected_matrix_b[it_398_0][it_398_1], matrix_b[it_398_0][it_398_1]);
        }
    }
}
