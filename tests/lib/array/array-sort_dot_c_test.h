...
extern "C" int sort_array_lib_array_array_sort_c(int *arr, int n);
static int sort_array(int *arr, int n) {
return sort_array_lib_array_array_sort_c(arr, n);
}
extern "C" int sort_array_with_comparator_lib_array_array_sort_c(int *arr, int n, int (*cmp)(int, int));
static int sort_array_with_comparator(int *arr, int n, int (*cmp)(int, int)) {
return sort_array_with_comparator_lib_array_array_sort_c(arr, n, cmp);
}
