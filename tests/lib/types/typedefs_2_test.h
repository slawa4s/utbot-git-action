...
extern "C" int enumSign1ToInt_lib_types_typedefs_2_c(Sign1 s);
static int enumSign1ToInt(Sign1 s) {
return enumSign1ToInt_lib_types_typedefs_2_c(s);
}
extern "C" Sign1 intToSign1_lib_types_typedefs_2_c(int a);
static Sign1 intToSign1(int a) {
return intToSign1_lib_types_typedefs_2_c(a);
}
extern "C" int enumSign2ToInt_lib_types_typedefs_2_c(Sign2 s);
static int enumSign2ToInt(Sign2 s) {
return enumSign2ToInt_lib_types_typedefs_2_c(s);
}
extern "C" Sign2 intToSign2_lib_types_typedefs_2_c(int a);
static Sign2 intToSign2(int a) {
return intToSign2_lib_types_typedefs_2_c(a);
}
