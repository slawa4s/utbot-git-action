...
extern "C" int (*x_lib_static_c);
int (&x) = (*x_lib_static_c);
extern "C" bool (*externed_global_lib_static_c);
bool (&externed_global) = (*externed_global_lib_static_c);
extern "C" int static_simple_lib_static_c(int dx);
static int static_simple(int dx) {
return static_simple_lib_static_c(dx);
}
extern "C" int static_accept_local_struct_lib_static_c(struct StaticStruct str, int index);
static int static_accept_local_struct(struct StaticStruct str, int index) {
return static_accept_local_struct_lib_static_c(str, index);
}
extern "C" struct StaticStruct static_return_local_struct_lib_static_c(int x, int y);
static struct StaticStruct static_return_local_struct(int x, int y) {
return static_return_local_struct_lib_static_c(x, y);
}
extern "C" int static_inline_sum_lib_static_c(int a, int b);
static int static_inline_sum(int a, int b) {
return static_inline_sum_lib_static_c(a, b);
}
