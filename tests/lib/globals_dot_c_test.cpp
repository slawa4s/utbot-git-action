...
TEST(regression, use_global_array_test_1)
{
    ...
    for (int it_412_0 = 0; it_412_0 < 3; it_412_0 ++) {
        EXPECT_EQ(expected_global_array[it_412_0], global_array[it_412_0]);
    }
}
...
TEST(regression, use_global_array_test_2)
{
    ...
    for (int it_413_0 = 0; it_413_0 < 3; it_413_0 ++) {
        EXPECT_EQ(expected_global_array[it_413_0], global_array[it_413_0]);
    }
}
