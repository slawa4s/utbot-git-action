...
TEST(regression, use_global_array_test_1)
{
    ...
    for (int it_414_0 = 0; it_414_0 < 3; it_414_0 ++) {
        EXPECT_EQ(expected_global_array[it_414_0], global_array[it_414_0]);
    }
}
...
TEST(regression, use_global_array_test_2)
{
    ...
    for (int it_415_0 = 0; it_415_0 < 3; it_415_0 ++) {
        EXPECT_EQ(expected_global_array[it_415_0], global_array[it_415_0]);
    }
}
...
TEST(regression, use_global_array_test_3)
{
    ...
    for (int it_416_0 = 0; it_416_0 < 3; it_416_0 ++) {
        EXPECT_EQ(expected_global_array[it_416_0], global_array[it_416_0]);
    }
}
