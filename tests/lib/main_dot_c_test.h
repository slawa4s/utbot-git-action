...
extern "C" int exit_code_lib_main_c(int argc);
static int exit_code(int argc) {
return exit_code_lib_main_c(argc);
}
extern "C" int main2_lib_main_c(int argc, char **argv);
static int main2(int argc, char **argv) {
return main2_lib_main_c(argc, argv);
}
extern "C" int main_lib_main_c(int argc, char **argv);
static int main(int argc, char **argv) {
return main_lib_main_c(argc, argv);
}
