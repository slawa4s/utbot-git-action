...
TEST(regression, five_square_numbers_test_1)
{
    ...
    int expected[1] = {0};
    for (int it_335_0 = 0; it_335_0 < 1; it_335_0 ++) {
        EXPECT_EQ(actual[it_335_0], expected[it_335_0]);
    }
}
...
TEST(regression, void_pointer_return_char_usage_test_1)
{
    ...
    for (int it_336_0 = 0; it_336_0 < 10; it_336_0 ++) {
        EXPECT_EQ(expected_a[it_336_0], a[it_336_0]);
    }
}
