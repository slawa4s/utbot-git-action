    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_404_0 = 0; it_404_0 < 10; it_404_0 ++) {
                klee_prefer_cex(receiver_f_symbolic, receiver_f_symbolic[it_404_0] >= -10  & receiver_f_symbolic[it_404_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_405_0 = 0; it_405_0 < 10; it_405_0 ++) {
                klee_prefer_cex(pointerToPointer_f_symbolic, pointerToPointer_f_symbolic[it_405_0] >= -10  & pointerToPointer_f_symbolic[it_405_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_406_0 = 0; it_406_0 < 10; it_406_0 ++) {
                klee_prefer_cex(structParam_f_symbolic, structParam_f_symbolic[it_406_0] >= -10  & structParam_f_symbolic[it_406_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_407_0 = 0; it_407_0 < 10; it_407_0 ++) {
                klee_prefer_cex(structPointerParam_f_symbolic, structPointerParam_f_symbolic[it_407_0] >= -10  & structPointerParam_f_symbolic[it_407_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_408_0 = 0; it_408_0 < 10; it_408_0 ++) {
                klee_prefer_cex(return_op_return_op_return_symbolic, return_op_return_op_return_symbolic[it_408_0] >= -10  & return_op_return_op_return_symbolic[it_408_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_409_0 = 0; it_409_0 < 10; it_409_0 ++) {
                klee_prefer_cex(f_chain_functions_symbolic, f_chain_functions_symbolic[it_409_0] >= -10  & f_chain_functions_symbolic[it_409_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_410_0 = 0; it_410_0 < 10; it_410_0 ++) {
                klee_prefer_cex(get_chain_get_chain_return_symbolic, get_chain_get_chain_return_symbolic[it_410_0] >= -10  & get_chain_get_chain_return_symbolic[it_410_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
...
TEST(regression, get_chain_test_2)
{
    ...
    *(unsigned char *)get_chain(c);
    char expected_c[] = {'c', '*', '*', '*', '*', '*', '*', '*', '-', '\0'};
    for (int it_412_0 = 0; it_412_0 < 10; it_412_0 ++) {
        EXPECT_EQ(expected_c[it_412_0], c[it_412_0]);
    }
}
...
TEST(regression, get_chain_test_3)
{
    ...
    *(unsigned char *)get_chain(c);
    ...
    for (int it_413_0 = 0; it_413_0 < 10; it_413_0 ++) {
        EXPECT_EQ(expected_c[it_413_0], c[it_413_0]);
    }
}
