...
extern "C" int calc_two_numbers_src_calc_c(char op, int a, int b);
static int calc_two_numbers(char op, int a, int b) {
return calc_two_numbers_src_calc_c(op, a, b);
}
extern "C" int f_src_calc_c(int a);
static int f(int a) {
return f_src_calc_c(a);
}
extern "C" int other_module_call_src_calc_c(int a);
static int other_module_call(int a) {
return other_module_call_src_calc_c(a);
}
extern "C" int calc_two_numbers_f_src_calc_c(char a, char b);
static int calc_two_numbers_f(char a, char b) {
return calc_two_numbers_f_src_calc_c(a, b);
}
